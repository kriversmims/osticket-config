...
<p>
<b>Roles</b> | Roles in osTicket define what actions a staff member can perform within the helpdesk system. They are tied to departments and help establish permission control for managing tickets, users, and internal workflows. In this instance, I created a new role called "Supreme Admin" and gave all permissions to this role.
</p>
<br />
...
<p>
<b>Departments</b> | Departments in osTicket are organizational units used to categorize and manage incoming tickets. They help route tickets to the right group of staff and control ticket visibility, access, and workflow based on team responsibilities. In the image above, I added a "SysAdmins" department. A SysAdmins department in osTicket would typically be responsible for handling system-level support requests and internal infrastructure issues. 
</p>
<br />
